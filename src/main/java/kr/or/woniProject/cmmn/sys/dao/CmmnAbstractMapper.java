package kr.or.woniProject.cmmn.sys.dao;
...
//postgre db 전용 추상화 클래스 
// 전자장부 프레임 워크 적용시 규칙 
//dao 는 extends EgovAbstractMapper  상속 받아야함 

/** postgre db 전용 추상화 클래스 
 * 전자장부 프레임 워크 적용시 규칙 
 * dao 는 extends EgovAbstractMapper  상속 받아야함
 * EgovAbstractMapper의 내용 복붙 
 * @author jeonghyewon
 *
 */
...
//		System.out.println(sqlSession.getConfig);
